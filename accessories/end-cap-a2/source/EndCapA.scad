// PongFetch A2 fit-refinement prototype. Same envelope as A1. Units: mm.
...
roof=1.20;
insertion=8.00;
fit="medium"; // [medium,firm]
contact_interference=fit=="firm" ? 0.40 : 0.30; // Diametral, nominal only.
contact_d=pipe_od-contact_interference; // 21.04 / 20.94 mm for nominal PVC.
// Keep three continuous ribs: do not add height or more contact points.
// Print full caps for retention trials; the roof affects shell compliance.
inlay_depth=0.40;
$fn=128;
eps=0.01;
